...
public class MyCube {
    ...
    public void draw(float[] vpMatrix) {
        ...
        float scalePoint = 0.25f;
        Matrix.scaleM(modelMatrix, 0, scalePoint,scalePoint,scalePoint);
        Matrix.translateM(modelMatrix, 0, 0f,0.5f, 0f);

        Matrix.translateM(modelMatrix, 0, frameCount/100f,0,0);
        ...
        if(frameCount == 60*5 || frameCount ==-300){
            frameCount=0;
            angle = 0;
            flag = !flag;
        }
